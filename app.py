...
# --- ENGINE MODUL 4: GLOBAL MARKET ANTI-BADAI ---
@st.cache_data(ttl=3600)
def get_global_market_data():
    ...
    # Berikan nilai default agar TIDAK AKAN PERNAH ERROR KeyError lagi
    data_results = {key: {'val': 0.0, 'pct': 0.0} for key in tickers.keys()}
    
    for name, sym in tickers.items():
        try:
            ticker = yf.Ticker(sym)
            hist = ticker.history(period="5d") # Tarik 5 hari mundur untuk menghindari libur/weekend
            if len(hist) >= 2:
...
# ==========================================
# TAB 1: FUNDING (RESTORED KE VERSI CANTIK)
# ==========================================
with tab1:
...
# ==========================================
# TAB 2: LENDING (RESTORED KE VERSI CANTIK)
# ==========================================
with tab2:
...
# ==========================================
# TAB 3: ALM RESUME (RESTORED KE VERSI CANTIK)
# ==========================================
with tab3:
...
# ==========================================
# TAB 4: GLOBAL MARKET & FX (DENGAN PERLINDUNGAN ANTI-BADAI)
# ==========================================
with tab4:
    ...
    st.divider()
    st.info("💡 **Tips Strategic:** Perhatikan pergerakan **Brent Oil** dan **USD/IDR**. Kenaikan pada kedua instrumen ini biasanya berdampak langsung pada kenaikan biaya operasional (BBM & Spareparts) armada feri.")
